                  ...
                  <div class="card p-3">
                    <div class="row">
                      ...
                      <div class="col-6">
                        ...
                        <p>74</p>
                        <p>100/70</p>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae, architecto ea
                          neque itaque nesciunt id, dignissimos saepe sint quos ipsam quis quo voluptatibus? Rem quaerat
                          fuga ipsam dolores ad.</p>
                      </div>
                    </div>
                  </div>
                  <br>
                  <div class="text-start">
                    <a href="formDK_ketua.php"><button type="submit" class="btn-view">Kembali</button></a>
                  </div>
                  </form>
                </div>
              </div>
